...
namespace CrossHotbar.EquipAnyInventory.Patch {
    ...
    internal class PlayerController {
        ...
        static bool IsAnySlotEquipped(global::PlayerController __instance, ref bool __result) {
            ...
            if (_slot.inventoryIndexReference != __instance.equippedSlotIndex) {
                ...
                Debug.LogWarning($"Index before slot management: ${_hotbar_lastUsed}");
                Debug.LogWarning($"Index of managed slot: ${_slot.inventoryIndexReference}");
